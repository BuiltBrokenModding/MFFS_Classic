...
dependencies {
    ...
    compileOnly("mezz.jei:jei-1.21.1-common-api:$versionJei")
    compileOnly("mezz.jei:jei-1.21.1-neoforge-api:$versionJei")
    // at runtime, use the full JEI jar for NeoForge
    runtimeOnly("mezz.jei:jei-1.21.1-neoforge:$versionJei")
