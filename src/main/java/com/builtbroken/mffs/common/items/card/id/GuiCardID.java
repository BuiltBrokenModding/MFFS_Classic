...
public class GuiCardID extends GuiContainerBase
{
    ...
    public void updateScreen()
    {
        ...
        if (stack == null || stack.getItem() != MFFS.itemCardID)
        {
            player.closeScreen();
            return;
        }
    ...
    public void actionPerformed(GuiButton button)
    {
        ...
        if (stack != null && stack.getItem() == MFFS.itemCardID)
        {
            ...
            {
                boolean state = MFFS.itemCardID.hasPermission(stack, Permission.values()[button.id]);
                MFFS.itemCardID.sendPermPacket(Minecraft.getMinecraft().thePlayer, button.id, !state);
            }
        }
    }
    ...
    protected void sendUsernamePacket()
    {
        ...
        if (stack != null && stack.getItem() == MFFS.itemCardID)
        {
            ...
            MFFS.itemCardID.sendUserNamePacket(Minecraft.getMinecraft().thePlayer, text);
        }
    }
