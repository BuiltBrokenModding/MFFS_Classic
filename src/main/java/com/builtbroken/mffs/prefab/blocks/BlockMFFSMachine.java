...
public abstract class BlockMFFSMachine extends Block implements ITileEntityProvider
{
    ...
    public void registerBlockIcons(IIconRegister reg)
    {
        ...
        this.blockIcon = reg.registerIcon(MFFS.DOMAIN + ":" + name);
        side_textures = new IIcon[]{
                reg.registerIcon(MFFS.DOMAIN + ":" + name + "_top"),
                reg.registerIcon(MFFS.DOMAIN + ":" + name + "_top_on"),
                reg.registerIcon(MFFS.DOMAIN + ":" + name + "_on")
        };
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ)
    {
        ...
        player.openGui(MFFS.INSTANCE, 0, world, x, y, z);
        return true;
    }
