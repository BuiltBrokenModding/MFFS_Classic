...
public class RenderFortronCapacitor extends TileEntitySpecialRenderer
{
    ...
    public static final ResourceLocation
            TEXTURE_ON = new ResourceLocation(MFFS.DOMAIN, "textures/models/coercionDeriver_on.png"),
            TEXTURE_OFF = new ResourceLocation(MFFS.DOMAIN, "textures/models/coercionDeriver_off.png");
