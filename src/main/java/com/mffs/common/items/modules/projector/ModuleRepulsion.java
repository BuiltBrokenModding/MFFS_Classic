 ...
 * @author Calclavia
 */
public final class ModuleRepulsion extends ItemModule {

    /**
     *
     */
    public ModuleRepulsion() {
        setCost(8);
    }
    ...
    public boolean onProject(IProjector projector, Set<Vector3D> fields) {
        double velocity = Math.max(projector.getModuleCount(ModuleRepulsion.class) / 20, 1.2);
