...
public final class ModAttachmentTypes {
    ...
    public static final Supplier<AttachmentType<CustomEnergyStorage>> BATTERY_ENERGY_STORAGE = ATTACHMENT_TYPES.register(
        "battery_energy_storage", () -> AttachmentType.serializable(() -> (CustomEnergyStorage) null).build());
    ...
    public static final Supplier<AttachmentType<IdentificationCardItem.IdentificationCardAttachment>> IDENTIFICATION_CARD_DATE = ATTACHMENT_TYPES.register(
        "identification_card_data", () -> AttachmentType.serializable(() -> (IdentificationCardItem.IdentificationCardAttachment) null).build());
