...
public final class ModMenus {
    ...
    public static final RegistryObject<MenuType<BiometricIdentifierMenu>> BIOMETRIC_IDENTIFIER_MENU = register("biometric_identifieer", BiometricIdentifierMenu::new);
