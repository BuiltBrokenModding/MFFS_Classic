...
public class FortronCapacitorScreen extends FortronScreen<FortronCapacitorMenu> {
    ...
    protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
        ...
        this.font.draw(poseStack, ModUtil.translate("screen", "fortron.value", this.menu.blockEntity.fortronStorage.getStoredFortron(), this.menu.blockEntity.fortronStorage.getMaxFortron()), 8, 105, GuiColors.DARK_GREY);
